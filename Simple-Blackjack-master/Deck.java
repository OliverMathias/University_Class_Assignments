...
// declaring the class
  ...
  Card BlackJackClubs = new Card("Clubs",10, "Jack","Black");
  Card RedJackDiamonds = new Card("Diamonds",10, "Jack","Red");
  Card RedJackHearts = new Card("Hearts",10, "Jack","Red");
  Card BlackJackSpades = new Card("Spades",10, "Jack","Black");
  Card BlackQueenClubs = new Card("Clubs",10, "Queen","Black");
  Card RedQueenDiamonds = new Card("Diamonds",10, "Queen","Red");
  Card RedQueenHearts = new Card("Hearts",10, "Queen","Red");
  Card BlackQueenSpades = new Card("Spades",10, "Queen","Black");
  Card RedKingHearts = new Card("Hearts",10,"King","Red");
  Card BlackKingClubs = new Card("Clubs",10,"King","Black");
  Card RedKingDiamonds = new Card("Diamonds",10,"King","Red");
  Card BlackKingSpades = new Card("Spades",10,"King","Black");
  Card RedAceHearts = new Card("Hearts",1,"Ace","Red");
  Card BlackAceClubs = new Card("Clubs",1,"Ace","Black");
  Card RedAceDiamonds = new Card("Diamonds",1,"Ace","Red");
  Card BlackAceSpades = new Card("Spades",1,"Ace","Black");
  ...
  /**
  *Randomly returns a card from the deck.
  ...
  *@return an int, which is the size of the deck.
